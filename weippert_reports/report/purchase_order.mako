...
<body>
  ...
  <table class="fullwidth" style="margin-top:2cm">
    <tr>
      ...
      <td>
        % if o.partner_id.customer and o.partner_id.ref:
          Kunden-Nr.
        % elif o.partner_id.supplier and o.partner_id.ref:
          Lieferanten-Nr.
        % endif
  ...
  <table style="margin-top:1cm">
    <tr><td>Ihr Angebot</td></tr>
  </table>

  <table style="margin-top:1cm">
    <tr>
      <td>
        Wir bestellen unter Zugrundelegung unserer Einkaufsbedingungen abrufbar
        unter ${ company.website } die unten aufgef&uuml;hrten Waren bzw. Dienstleistungen.
      </td>
    </tr>
  </table>
